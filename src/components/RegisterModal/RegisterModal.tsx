...
export const RegisterModal: React.FC<RegisterModalProps> = ({ onClose }) => {
  ...
  return (
    <div className={styles["register-modal"]} onClick={handleClose}>
      <div
        className={styles["register-modal__body"]}
      ...
      >
        ...
        <div className={styles["brand-header"]}>
          ...
          <p className={styles["brand-header__subtitle"]}>
            <span className={styles["brand-header__subtitle-mobile"]}>
              Crea tu cuenta para empezar a construir.
            </span>
            <span className={styles["brand-header__subtitle-desktop"]}>
              Únete al futuro de la tecnología.
            </span>
          </p>
        </div>
        ...
        <div className={styles["auth-card"]}>
          ...
          <form
            ...
            className={styles["auth-card__form"]}
            autoComplete="off"
          >
            <div className={styles["form-field"]}>
              <label className={styles["form-field__label"]} htmlFor="fullName">
                Nombre Completo
              </label>
            ...
            <div className={styles["form-field"]}>
              <label className={styles["form-field__label"]} htmlFor="email">
                Dirección de Email
              </label>
              <div className={styles["form-field__control"]}>
            ...
            <div className={styles["form-field"]}>
              <label className={styles["form-field__label"]} htmlFor="password">
                Contraseña
              </label>
              <div className={styles["form-field__control"]}>
            ...
            <div
              className={`${styles["form-field"]} ${styles["form-field--account-type"]}`}
            >
              <label
              ...
              <div className={styles["form-field__control"]}>
                ...
                <ChevronDown
                  size={18}
                  className={styles["form-field__select-arrow"]}
                />
              </div>
            </div>
